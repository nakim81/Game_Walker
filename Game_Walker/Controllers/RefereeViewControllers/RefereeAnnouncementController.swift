...
class RefereeAnnouncementViewController: UIViewController {
    ...
    private func setUpViews() {
        ...
        containerView.addSubview(announcementTextLabel)
    ...
    private func makeConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            announcementTextLabel.leadingAnchor.constraint(equalTo: containerView.leadingAnchor, constant: 8),
            announcementTextLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -8),
            announcementTextLabel.topAnchor.constraint(equalTo: announcementLabel.bottomAnchor, constant: 2),
            announcementTextLabel.heightAnchor.constraint(equalTo: announcementTextLabel.widthAnchor, multiplier: 0.53),
            announcementTextLabel.centerXAnchor.constraint(equalTo: containerView.centerXAnchor),
            ...
            buttonView.topAnchor.constraint(equalTo: announcementTextLabel.bottomAnchor, constant: 10.0),
