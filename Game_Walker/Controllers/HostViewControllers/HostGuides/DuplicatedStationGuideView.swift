//
//  DuplicatedStationGuideViewController.swift
//  Game_Walker
//
...
class DuplicatedStationGuideView : UIView {
    ...
    private let titleImage = UIImageView(image: UIImage(named: "DuplicatedStation"))
    ...
    private func setupGif() {
        let path1 : String = Bundle.main.path(forResource: "duplicated-stations-sample", ofType: "gif")!
