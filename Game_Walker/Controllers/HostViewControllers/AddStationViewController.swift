...
//        
//        refereeTableView.frame = CGRect(x: self.refereeButton.frame.origin.x,
//                                        y: self.refereeButton.frame.origin.y,
//                                        width: self.refereeButton.frame.width,
//                                        height: 0)
...
//            refereeTableView.leftAnchor.constraint(equalTo: refereeButton.leftAnchor),
//            refereeTableView.topAnchor.constraint(equalTo: refereeButton.topAnchor),
//            refereeTableView.rightAnchor.constraint(equalTo: refereeButton.rightAnchor),
//        ])
//    }
//    
...
//            self.refereeTableView.frame = CGRect(
//                x: self.refereeButton.frame.origin.x,
//                y: self.refereeButton.frame.origin.y,
//                width: self.refereeButton.frame.width,
//                height: 0)
//        }, completion: nil)
